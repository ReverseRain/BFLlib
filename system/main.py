...
from flcore.servers.serverNeurotoxin import FedNeurotoxin
from flcore.servers.serverChameleon import FedChameleon
from flcore.servers.serverGhost import FedGhost
...
def run(arg):
    ...
    if args.algorithm == "FedAVG":
        ...
        server = FedAvg(args)
    elif args.algorithm == "Neurotoxin":
        args.head = copy.deepcopy(args.model.fc)
        args.model.fc = nn.Identity()
        args.model = BaseHeadSplit(args.model, args.head)
        server = FedNeurotoxin(args)
    elif args.algorithm == "Chameleon":
        args.head = copy.deepcopy(args.model.fc)
        args.model.fc = nn.Identity()
        args.model = BaseHeadSplit(args.model, args.head)
        server = FedChameleon(args)
    elif args.algorithm == "Ghost":
        args.head = copy.deepcopy(args.model.fc)
        args.model.fc = nn.Identity()
        args.model = BaseHeadSplit(args.model, args.head)
        server = FedGhost(args)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-ac","--attack_clients", nargs='+', type=int,default=None,
